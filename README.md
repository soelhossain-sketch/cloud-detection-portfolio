...
Detection engineering and SOC automation work by **Syed Soel Hossain** — SOC L3 → Cloud Detection SOC Engineer.
...
- **/detection-testing** — detections validated with Atomic Red Team (writeups + screenshots)
- **/dfir-detections** — detections built from real intrusion reports
- **/automation** — n8n SOC alert-enrichment workflow (with AI triage) + diagram
